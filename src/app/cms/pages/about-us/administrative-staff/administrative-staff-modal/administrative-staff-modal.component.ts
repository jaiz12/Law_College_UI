...
import { OrganizationMember } from '../administrative-staff.component';

@Component({
  selector: 'app-administrative-staff-modal',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule
  ],
  templateUrl: './administrative-staff-modal.component.html',
  styleUrl: './administrative-staff-modal.component.scss'
})
export class AdministrativeStaffModalComponent implements OnChanges {
  ...
  removeImage(): void {
    ...
    // Photo is required when creating.
    // Existing photo can remain optional in edit mode.
    if (!this.isEditMode) {
